...
Operating rules:
1. Treat `STATE.md`, `README.md`, `CHANGELOG.md`, `USAGE.md`, context packs, and ADRs as canonical documentation surfaces.
2. Do not invent features. Anchor every documentation update in source code, git history, or generated state.
3. Preserve project terminology: Epoch, Era, Wave, ADR, AED, Capability, Manifest, Authority, State Engine.
